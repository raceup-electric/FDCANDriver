...
/**
 * @brief  Initializes the FDCAN MSP (Low Level Resources).
 * @note   Configures Clocks (PLL2Q), GPIOs, and NVIC.
 * @warning **CRITICAL**: The Bitrate calculations in RUP_FDCAN_Init depend 
 * entirely on the PLL2Q settings defined here. Changing these 
 * parameters without updating the prescalers will break communication.
